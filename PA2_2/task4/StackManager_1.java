...
import task1.Semaphore_1;

// Source code for stack manager:

public class StackManager_1 {
	// The Stack
	...
	private static Semaphore_1 MUTEX = new Semaphore_1(1);
	private static Semaphore_1 MUTEX_RESOURCE = new Semaphore_1(-5);
	// The main()
	...
	static class Consumer extends BaseThread {
		...
		public void run() {
			...
			for (int i = 0; i < StackManager_1.iThreadSteps; i++) {
				// Insert your code in the following:
				StackManager_1.MUTEX_RESOURCE.P();
				try {
				...
				StackManager_1.MUTEX_RESOURCE.V();
			}
	...
	static class CharStackProber extends BaseThread {
		public void run() {
			...
			for (int i = 0; i < 2 * StackManager_1.iThreadSteps; i++) {
