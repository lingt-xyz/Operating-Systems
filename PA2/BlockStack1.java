...
/**
 * Task 1: Writing Some Java Code, Part I Declare an integer “stack access
 * counter” variable in the BlockStack class. Have it incremented by 1 every
 * time the stack is accessed (i.e. via push(), pop(), pick(), or getAt()
 * methods). When the main thread terminates, print out the counter's value.
 * Submit the modified code and the output.
 *
 */
class BlockStack1 {
	/**
